...
<h2 class="main-content-title tx-24 mg-b-5 pd-l-18 fw-200"><?php echo e(__('Account Report')); ?></h2>
<ol class="breadcrumb pd-l-18">
    <li class="breadcrumb-item"><a href="/user/dashboard"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item active"><?php echo e(__("Account")); ?></li>
</ol>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('pagecontent'); ?>
<div class="row pd-l-18">
  <div class="col-12">
    <div class="">
      <div class="">
        <div class="d-none">
                    ...
                    <?php else: ?>
                      <?php if($t->type == 0): ?>
                        ...
                        <?php echo e(__("Transfer to ")); ?>
                          ...
                          <?php if($t->destinationtx()->user_id == \Auth::user()->id): ?>
                          <a href="<?php echo e(route('user.account.view', $t->destinationtx()->account->id)); ?>">
                      ...
                      <?php else: ?>
                        ...
                        <?php echo e(__("Transfer from ")); ?>
                          ...
                          <?php if($t->origintx->user_id == \Auth::user()->id): ?>
                          <a href="<?php echo e(route('user.account.view', $t->origintx->account->id)); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('user.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yacin\Downloads\Laravelle\intialClone\ebanqmbi\script\resources\views/user/accounts/view.blade.php ENDPATH**/ ?>