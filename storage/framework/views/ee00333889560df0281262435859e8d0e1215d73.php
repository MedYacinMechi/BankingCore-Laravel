<table class="transactions main-default-table main-default-table-clickable col-md-12 table table-bordered">
<thead>
    <tr>
...
<tbody class="bg-fafafa">
    ...
    <tr data-txid="<?php echo e($transaction->id); ?>">
        <td>
            <?php if($transaction->originid == null && $transaction->destuserid == null): ?>
                <a href="<?php echo e(route('admin.accounts.view', $transaction->account->id)); ?>"><?php echo e($transaction->account->identifier); ?></a>
            ...
            <?php else: ?>
                <?php if($transaction->type == 0): ?>
                    <?php if($transaction->user_id == $transaction->destuserid): ?>
                        <a href="<?php echo e(route('admin.accounts.view', $transaction->account->id)); ?>">
                            <?php echo e($transaction->account->identifier); ?>

                        </a>
                        <span class="color-a7a7a7 pd-lr-5 fa fa-angle-right"></span>
                        <a href="<?php echo e(route('admin.accounts.view', $transaction->destinationtx()->account->id)); ?>">
                    ...
                    <?php else: ?>
                      ...
                      <a href="<?php echo e(route('admin.users.show', $transaction->destinationtx()->user->id)); ?>">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('admin.accounts.view', $transaction->account->id)); ?>"><?php echo e($transaction->account->identifier); ?></a>
                    <span class="color-a7a7a7 pd-lr-5 fa fa-angle-left"></span>
                    <a href="<?php echo e(route('admin.accounts.view', $transaction->origintx->account->id)); ?>">
        ...
        <td class="tx-center">
            ...
            <?php else: ?>
                <?php if($transaction->type == 0): ?>
                    ...
                    <span class="iconify" data-icon="carbon:arrows-horizontal" data-width="16" data-height="16" data-bs-placement="top" data-bs-toggle="tooltip" title="<?php echo e(__('Between User Accounts')); ?>"></span>
                    <?php else: ?>
    ...
    <tr data-txid="<?php echo e($transaction->id); ?>">
        <td>
            ...
            <?php else: ?>
                <?php echo e($transaction->wire->_59_iban); ?>
...
</table><?php /**PATH C:\Users\Yacin\Downloads\Laravelle\intialClone\ebanqmbi\script\resources\views/admin/transactions/user_table.blade.php ENDPATH**/ ?>