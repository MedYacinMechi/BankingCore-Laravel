...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><?php echo e(__('Between Accounts')); ?></li>
</ol>
        ...
        <?php endif; ?>
            ...
            <div class="row mg-t-10">
                ...
                <div class="col-lg-6 form-group">
                    ...
                    <div class="form-group">
                        <select name="payee_accountnum_select" class="w-100 form-group text-start recipient-select">
                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option data-currency="<?php echo e($acc->currency->ISOcode); ?>" value="<?php echo e($acc->identifier); ?>"><?php echo e($acc->identifier." - My Account (".$acc->currency->ISOcode.")"); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('user.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yacin\Downloads\Laravelle\intialClone\ebanqmbi\script\resources\views/user/transfer/betweenaccounts.blade.php ENDPATH**/ ?>